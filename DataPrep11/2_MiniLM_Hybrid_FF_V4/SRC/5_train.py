    ...
    def train(self) -> bool:
        ...
        for epoch in range(start_epoch, Config.NUM_EPOCHS + 1):
            ...
            if Config.CLASSIFICATION_LAYER_TYPE == "sigmoid":
                if len(val_logits.shape) > 1 and val_logits.shape[1] == 1:
                    val_logits_squeezed = val_logits.squeeze(-1)
                else:
                    val_logits_squeezed = val_logits
                calibrated_logits = val_logits_squeezed / temp
