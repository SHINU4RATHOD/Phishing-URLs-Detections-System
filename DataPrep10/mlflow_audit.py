...
try:
    ...
    print("❌ mlflow is not installed in the virtualenv. Please check the virtualenv.")
    sys.exit(1)
...
def audit_subproject(name: str, db_path: Path):
    ...
    try:
        ...
        print(f"❌ Failed to audit database: {e}")

def main():
    root = Path(__file__).resolve().parent
    sub1 = root / "1_MiniLM_V4_Model_On_Raw_Data_and_OFP_and_Canonical_Inferencing" / "mlflow.db"
